...
class EPayslipBach(models.Model):
    ...
    def firmar_facturae(self, xml_facturae):
        ...
        def _sign_file(cert, password, request):
            ...
            p12 = crypto.load_pkcs12(base64.b64decode(self.company_id.connection_payslip_id.certificate_id.cert_file), self.company_id.connection_payslip_id.certificate_id.cert_pass)
