        ...
        for move in obj_account_moves:
            try:
                ...
                for items in move.invoice_line_ids:
                    ...
                    lst_move = [doc,year,num,invoice_date,nit,partner,classification,represent_logyca_name,city,street,phone,mobile,represent_logyca_email,contact_fe,vinculations,asset_range,income_range,type_invoice,account,date_due,payment_term,ref,origin,
