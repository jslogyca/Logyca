...
class MassiveInvoicingCXC_report(models.TransientModel):
    ...
    def get_details(self):
        ...
        obj_account_moves = self.env['account.move'].search([('x_is_mass_billing', '=', True),('move_type','=','out_invoice'),('invoice_date','>=',date_initial_filter),('invoice_date','<=',date_finally_filter)]) 
