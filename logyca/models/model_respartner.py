...
class ResPartner(models.Model):
    ...
    x_ciiu_activity = fields.Many2many('logyca.ciiu', string='Códigos CIIU', track_visibility='onchange')
    ...
    # def init(self):
    #     self._cr.execute("Select name From res_partner as a Inner Join res_partner_logyca_contact_types_rel as b on a.id = b.res_partner_id and b.logyca_contact_types_id = 3 Where a.vat='"+str(self.vat)+"'")
