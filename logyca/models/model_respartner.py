...
class ResPartner(models.Model):
    ...
    x_history_partner_notes = fields.One2many('logyca.history_partner_notes', 'parent_id', string = 'Notas')
    x_history_partner_emails = fields.One2many('logyca.history_partner_emails', 'parent_id', string = 'Emails')
