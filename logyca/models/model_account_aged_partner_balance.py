...
class ReportAgedPartnerBalance(models.AbstractModel):
    ...
    def _get_partner_move_lines(self, account_type, date_from, target_move, period_length):
        ...
        query = '''
            SELECT DISTINCT l.partner_id, res_partner.vat ||' | '|| res_partner.name AS name, res_partner.vat as vat, UPPER(res_partner.name) AS UPNAME, CASE WHEN prop.value_text IS NULL THEN 'normal' ELSE prop.value_text END AS trust
