...
class MisuseGS1LogFollowUp(models.Model):
    ...
    misuse_log_followup_id = fields.Many2one('misuse.gs1.log', string='Log', required=True, ondelete='cascade')
...
class MisuseGs1Log(models.Model):
    ...
    follow_up = fields.One2many('misuse.gs1.log.followup', 'misuse_log_followup_id', string='Follow-up')
