...
class Survey(models.Model):
    ...
    qrcode = fields.Binary(compute='_compute_qrcode')
    success_ratio_average = fields.Integer(compute="_compute_survey_statistic")
...
class SurveyQuestionAnswer(models.Model):
    ...
    company_id = fields.Many2one(related='question_id.survey_id.company_id')
